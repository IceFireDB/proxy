...
func LoadConf(configFile string) (*Conf, error) {
	...
	srvConf.coordinatorType, _ = conf.ReadString("coordinator_type", "etcd")
	srvConf.coordinatorAddr, _ = conf.ReadString("coordinator_addr", "localhost:2379")

	srvConf.slot_num, _ = conf.ReadInt("slot_num", 128)
